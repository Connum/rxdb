...
exports.SylvieSaveQueue = void 0;
 ...
 */
var SylvieSaveQueue = exports.SylvieSaveQueue = /*#__PURE__*/function () {
  /**
  ...
  function SylvieSaveQueue(sylvieDatabase, databaseSettings) {
    this.writesSinceLastRun = 0;
    this.saveQueue = _index.PROMISE_RESOLVE_VOID;
    this.saveQueueC = 0;
    this.sylvieDatabase = sylvieDatabase;
    this.databaseSettings = databaseSettings;
  }
  var _proto = SylvieSaveQueue.prototype;
  ...
  _proto.run = function run() {
    ...
    this.saveQueue = this.saveQueue.then(async () => {
      ...
      return new Promise((res, rej) => {
        this.sylvieDatabase.saveDatabase(err => {
          if (err) {
  ...
  return SylvieSaveQueue;
}();
//# sourceMappingURL=sylvie-save-queue.js.map