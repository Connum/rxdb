...
exports.SYLVIE_KEY_OBJECT_BROADCAST_CHANNEL_MESSAGE_TYPE = exports.SYLVIE_BROADCAST_CHANNEL_MESSAGE_TYPE = exports.SYLVIEJS_COLLECTION_DEFAULT_OPTIONS = exports.RX_STORAGE_NAME_SYLVIEJS = exports.OPEN_SYLVIEJS_STORAGE_INSTANCES = exports.CHANGES_COLLECTION_SUFFIX = void 0;
exports.closeSylvieCollections = closeSylvieCollections;
exports.getSylvieDatabase = getSylvieDatabase;
exports.getSylvieLeaderElector = getSylvieLeaderElector;
exports.getSylvieSortComparator = getSylvieSortComparator;
...
exports.stripSylvieKey = stripSylvieKey;
...
var _sylviejs = _interopRequireDefault(require("sylviejs"));
var _unload = require("unload");
var _index = require("../utils/index.js");
var _sylvieSaveQueue = require("./sylvie-save-queue.js");
...
var SYLVIE_BROADCAST_CHANNEL_MESSAGE_TYPE = exports.SYLVIE_BROADCAST_CHANNEL_MESSAGE_TYPE = 'rxdb-sylviejs-remote-request';
var SYLVIE_KEY_OBJECT_BROADCAST_CHANNEL_MESSAGE_TYPE = exports.SYLVIE_KEY_OBJECT_BROADCAST_CHANNEL_MESSAGE_TYPE = 'rxdb-sylviejs-remote-request-key-object';
var RX_STORAGE_NAME_SYLVIEJS = exports.RX_STORAGE_NAME_SYLVIEJS = 'sylviejs';

/**
 * Sylvie attaches a $loki property to all data
 * which must be removed before returning the data back to RxDB.
 */
function stripSylvieKey(docData) {
  if (!docData.$loki) {
    return docData;
  }
 ...
 */
var OPEN_SYLVIEJS_STORAGE_INSTANCES = exports.OPEN_SYLVIEJS_STORAGE_INSTANCES = new Set();
var SYLVIEJS_COLLECTION_DEFAULT_OPTIONS = exports.SYLVIEJS_COLLECTION_DEFAULT_OPTIONS = {
...
var SYLVIE_DATABASE_STATE_BY_NAME = new Map();
function getSylvieDatabase(databaseName, databaseSettings) {
  return (0, _index.getFromMapOrCreate)(SYLVIE_DATABASE_STATE_BY_NAME, databaseName, () => {
    /**
    ...
    var databaseState = (async () => {
      ...
      // overwrites
      {
         ...
         * so we disable the SylvieJS save/load handlers.
         */
        autoload: false,
        autosave: false,
        throttledSaves: false
      });
      var database = new _sylviejs.default(databaseName + '.db', (0, _index.flatClone)(useSettings));
      var sylvieSaveQueue = new _sylvieSaveQueue.SylvieSaveQueue(database, useSettings);
      ...
      if (hasPersistence) {
        ...
        sylvieSaveQueue.saveQueue = sylvieSaveQueue.saveQueue.then(() => loadDatabasePromise);
      ...
      var unloads = [];
      if (hasPersistence) {
        unloads.push((0, _unload.add)(() => sylvieSaveQueue.run()));
      }
      var state = {
        database,
...
async function closeSylvieCollections(databaseName, collections) {
  var databaseState = await SYLVIE_DATABASE_STATE_BY_NAME.get(databaseName);
  if (!databaseState) {
    // already closed
    return;
  }
  ...
  if (Object.keys(databaseState.collections).length === 0) {
    ...
    SYLVIE_DATABASE_STATE_BY_NAME.delete(databaseName);
...
/**
 * This function is at sylviejs-helper
 * because we need it in multiple places.
 */
function getSylvieSortComparator(_schema, query) {
  if (!query.sort) {
...
function getSylvieLeaderElector(databaseInstanceToken, broadcastChannelRefObject, databaseName) {
  var broadcastChannel = (0, _rxStorageMultiinstance.getBroadcastChannelReference)(RX_STORAGE_NAME_SYLVIEJS, databaseInstanceToken, databaseName, broadcastChannelRefObject);
...
async function requestRemoteInstance(instance, operation, params) {
  var isRxStorageInstanceSylvie = typeof instance.query === 'function';
  var messageType = isRxStorageInstanceSylvie ? SYLVIE_BROADCAST_CHANNEL_MESSAGE_TYPE : SYLVIE_KEY_OBJECT_BROADCAST_CHANNEL_MESSAGE_TYPE;
...
async function handleRemoteRequest(instance, msg) {
  if (msg.type === SYLVIE_BROADCAST_CHANNEL_MESSAGE_TYPE && msg.requestId && msg.databaseName === instance.databaseName && msg.collectionName === instance.collectionName && !msg.response) {
...
async function mustUseLocalState(instance) {
  ...
  if (leaderElector.isLeader && !instance.internals.localState) {
    ...
    instance.internals.localState = (0, _rxStorageInstanceSylvie.createSylvieLocalState)({
...
/**
 * SylvieJS does not understand the 'official' $regex operator,
...
//# sourceMappingURL=sylviejs-helper.js.map